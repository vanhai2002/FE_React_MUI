...
const Checkout: React.FC = () => {
  ...
  const { data, isLoading, error } = useCartsQuery(userId);
  ...
  const handleSubmit = async(e: FormEvent) => {
    ...
    console.log("Tổng tiền:", formatCurrencyVND(totalAmount));
  };
                        ...
                        <Grid container alignItems="center" spacing={2}>
                          ...
                          <Grid item>
                            <Box display="flex" alignItems="center">
                              <IconButton
                                color="inherit"
                                onClick={() =>
                                  decrementQuantity.mutate(item._id)
                                }
                              >
                                <RemoveIcon />
                              </IconButton>
                              ...
                              <IconButton
                                color="inherit"
                                onClick={() =>
                                  incrementQuantity.mutate(item._id!)
                                }
                              >
                                <AddIcon />
                              </IconButton>
                          ...
                          <Grid item>
                            <IconButton
                              color="inherit"
                              onClick={() =>
                                RemoverementQuantity.mutate(item._id)
                              }
                            >
                              <DeleteIcon />
                            </IconButton>
